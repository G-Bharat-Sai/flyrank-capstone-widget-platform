...
2. Create a widget (`POST /widgets`) with a custom set of fields (name, email, whatever), a button label, optionally a webhook URL to get notified of new submissions, and optionally proof-of-work bot protection (`requireProofOfWork`).
